package com.example.storymapapp.customView
...
class NameEditText : AppCompatEditText, View.OnTouchListener {
    ...
    private fun init() {
        ...
        nameImage = ContextCompat.getDrawable(context, R.drawable.ic_nama) as Drawable
        ...
        addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
                ...
                if (s.length > 20) {
                    error = resources.getString(R.string.name_error_too_long)
                }
    ...
    private fun setButtonDrawables(
        startOfTheText: Drawable? = nameImage,
